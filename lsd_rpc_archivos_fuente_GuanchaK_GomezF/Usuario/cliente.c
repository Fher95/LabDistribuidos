...
gestion_hamburguesa_1(char *host)
{
	...
	nodo_factura  *result_7;
	char *mostrarfactura_1_arg;
	bool_t  *result_8;
	char  generarpago_1_arg;
	proxNodoHamburguesa  *result_9;
	...
	result_5 = modificarcompra_1(&modificarcompra_1_arg, clnt);
	if (result_5 == (bool_t *) NULL) {
		clnt_perror (clnt, "call failed");
	}
	result_6 = eliminarahamburguesa_1(&eliminarahamburguesa_1_arg, clnt);
	if (result_6 == (bool_t *) NULL) {
		clnt_perror (clnt, "call failed");
	}
	result_7 = mostrarfactura_1((void*)&mostrarfactura_1_arg, clnt);
	if (result_7 == (nodo_factura *) NULL) {
		clnt_perror (clnt, "call failed");
	}
	result_8 = generarpago_1(&generarpago_1_arg, clnt);
	if (result_8 == (bool_t *) NULL) {
		clnt_perror (clnt, "call failed");
	}
	result_9 = listarhamburguesassistema_1((void*)&listarhamburguesassistema_1_arg, clnt);
	if (result_9 == (proxNodoHamburguesa *) NULL) {
		clnt_perror (clnt, "call failed");
	}
#ifndef	DEBUG
	clnt_destroy (clnt);
